<x-app-layout title="Audition">
    <section class="flex items-center justify-center px-4 py-20 overflow-hidden">
        ...
        <div class="flex flex-col lg:max-w-3xl xl:max-w-5xl px-4 gap-8 lg:gap-18 w-full text-center">
                    ...
                    @foreach($chapters as $chapter)
                        ...
                        >
                            ...
                            @if(! empty($chapter->thumbnail_urls))
                                <div class="relative w-4/7 shrink-0 self-stretch overflow-hidden bg-base-300">
                                    <img
